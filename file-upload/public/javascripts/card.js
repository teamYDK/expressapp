              ...
              '</div>' +
                '<div class="content2">' +
                  ...
                  '</div>'+
                    ...
                    '<span class="right floated">' + '<i class="heart outline icon0">'+ '</i>' + this.likes.count +' likes'+'</span>' +
							'<span class="left floated">' + '<i class="comments outline icon0">'+ '</i>' + this.comments.count +' comments'+'</span>' +
                    '</div>' +
                  '</div>'+
                '</div>'
      ).appendTo('#instafeed');
