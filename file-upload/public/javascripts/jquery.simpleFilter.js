	...
	$("p#class_name").text(class_name);

	var classCount = $(this).length; //.aaaというクラスの数を取得
	$("p#count").text(class_name + ' : ' + classCount); //p#countにクラスの数を表示*/

		//document.write('<p id="class_name"></p><p id="count"></p>');
		...
		console.log('insert canvas data');
		$(this).attr('src', data);
